            ...
            <el-popover placement="bottom" width="400" trigger="click">
                <el-row v-loading="Loading">
                    ...
                    <div style="text-align: center">
                        <el-button v-if="!created" type="primary" size="medium" :loading="Trading" @click="CreatePlayer" round plain>创建用户
                        </el-button>
                ...
                <span slot="reference" class="el-dropdown-link userinfo-inner">
                    <img @click="getBalance" src="https://s1.ax1x.com/2020/08/24/dBjEb4.png" />
                    <el-button v-if="Address !== ''" slot="reference" type="success" icon="el-icon-check" circle size="mini">{{"已连接"}}</el-button>
                </span>
            </el-popover>
        </el-col>
    </el-col>
            ...
            <el-menu :default-active="$route.path" class="el-menu-vertical-demo" @open="handleopen" @close="handleclose" @select="handleselect" unique-opened router>
                <template v-for="(item,index) in $router.options.routes" v-if="!item.hidden">
                    <el-submenu :index="index+''" v-if="!item.leaf">
                        ...
                        <el-menu-item v-for="child in item.children" :index="child.path" :key="child.path" v-if="!child.hidden"><i :class="child.iconCls"></i>{{child.name}}
                        </el-menu-item>
                    </el-submenu>
