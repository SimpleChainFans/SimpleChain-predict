    ...
    <el-card class="box-card">
        ...
        <div class="text item">
            <el-form :model="dynamicValidateForm" ref="dynamicValidateForm" label-width="100px" class="demo-dynamic">
                <el-form-item prop="name" label="事件内容" :rules="[
                ...
                <el-form-item v-for="(option, index) in dynamicValidateForm.option" :label="'选项' + (index + 1)" :key="option.key" :prop="'option.' + index + '.value'" :rules="{
                ...
                <el-form-item label="截至时间" required>
                    <el-col :span="11">
                        <el-form-item prop="date" :rules="[
                            ...
                            <el-date-picker type="datetime" placeholder="选择日期时间" v-model="dynamicValidateForm.date" :picker-options="pickerOptions" style="width: 100%;">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                </el-form-item>
                <el-form-item prop="addr" label="汇报人地址" :rules="[
                ...
                <el-form-item>
                    ...
                    <span style="margin-left: 20px" v-if="Trading">
                        <el-link :href="'https://test-explorer.simplechain.com/transaction/'+Hash" type="primary" target="_blank">交易正在确认中...</el-link>
                    </span>
                </el-form-item>
            </el-form>
        </div>
    ...
    methods: {
        ...
        InitiateEvent(content, option, Validity, addr) {
            ...
            this.$InitiateEvent(content, option, Validity, addr).on('transactionHash', function (hash) {
                ...
                _this.notify1('失败', '交易失败，详情见SimPlug', 'error', 0)
            });
        },
        notify(value) {
            const h = this.$createElement;
            this.$notify({
                title: '交易Hash,详情见SimPlug',
                message: h('i', {
                    style: 'color: teal'
                }, value)
            });
